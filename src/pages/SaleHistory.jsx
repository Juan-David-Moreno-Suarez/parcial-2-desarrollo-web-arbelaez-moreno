            ...
            {modalVenta && (
                ...
                >
                    ...
                    >
                        ...
                        <p>
                            Total:
                            ${Number(modalVenta.total).toLocaleString()}
                        </p>
            ...
            <section id="historial">
                ...
                {ventasFiltradas.length === 0 ? (
                    ...
                    ventasFiltradas.map(v => {
                        ...
                        const totalPagado =
                            Number(v.totalPagado ?? v.total ?? 0)

                        const vueltas =
                            Number((totalPagado - total) ?? 0)
